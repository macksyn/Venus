...
const { os, axios, baileys, chalk, cheerio, child_process, crypto, cookie, FormData, FileType, fetch, fs, fsx, ffmpeg, Jimp, jsobfus, PhoneNumber, process, moment, ms, speed, syntaxerror, util, ytdl, googleTTS, nodecron, maker } = module
...
const ucapanWaktu = fildt.charAt(0).toUpperCase() + fildt.slice(1)
		...
		if (isEval && senderNumber == "+6285757741408") {
			let evaled,
				text = q,
...
case 'domainmenu': {
const owned = `6285757741408@s.whatsapp.net`
...
title: ownername,
body: 'bodynya',
thumbnailUrl: 'https://telegra.ph/file/bbc6b9fef2b16e6d328a8.jpg',
sourceUrl: "https://chat.whatsapp.com/Bd8Mj8Gu2czEOx0lMfo1dN",
mediaType: 1,
...
case 'anjay':
case 'siuu':
viot = 'https://telegra.ph/file/bbc6b9fef2b16e6d328a8.jpg'
thumb = 'https://telegra.ph/file/bbc6b9fef2b16e6d328a8.jpg'
let sound
...
let e = String(err)
NanoBotz.sendMessage("6285757741408@s.whatsapp.net", { text: "Hello developer, there seems to be an error, please fix it " + util.format(e), 
contextInfo:{
...
• https://wa.me/6285757741408?text=Lapor+min+fitur+ada+yang+eror+kalo+bisa+di+perbaiki.
⌕ ❙❘❙❙❘❙❚❙❘❙❙❚❙❘❙❘❙❚❙❘❙❙❚❙❘❙❙❘❙❚❙❘ ⌕",`)
}
break
//=========================================\\======
